# CONTRIBUTING.md for `idem`

Thank you! We welcome contributions to `idem` 🎉

Before contributing to this project, please discuss the changes you wish to make via [Issues](https://github.com/bright-room/idem/issues). This helps maintain the project's consistency and ensures smooth collaboration.

## 💡 How to Contribute

### 1. Create or Check Issues
- If you want to add a new feature or fix a bug, first check the existing [Issues](https://github.com/bright-room/idem/issues) to see if a related issue already exists.
...
- Fork the `idem` repository and work on your own fork.
- Create a new branch with a descriptive name (e.g., `feature/add-redis-storage`, `fix/bug-123`).
