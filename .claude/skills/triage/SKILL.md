---
name: triage
description: Issue の棚卸を行う。対応済み Issue のクローズ、マイルストーンの平準化、実装プランの今後の展望から新規 Issue を作成する。
---
...
#### 2.2 マイルストーン未割り当て Issue の処理

マイルストーンが未割り当ての Issue（Dependency Dashboard を除く）を特定する。

#### 2.3 ラベルに基づくマイルストーン割り当てルール
...
#### 3.4 作成した Issue のマイルストーン割り当て

作成した Issue にも、ラベルに基づいて適切なマイルストーンを割り当てる（手順 2 のルールに従う）。
